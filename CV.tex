...
Working to integrate machine learning algorithms into the predictive analytics department by using large databases of client data to find patterns and predict their involvement with the company. Single-handedly built a pipeline from the group up that ingests client data, cleans and extracts features, compares machine learning models, and returns final predictions.
}
