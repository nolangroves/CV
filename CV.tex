...
\quote{Skilled programmer with a strong foundation built from physics, electronics, data-science, and research experience.
...
\cventry{Jun 2022 -- Current}{Data Analyst}{Affinaquest}{}{}{
Working to integrate machine learning algorithms into the predictive analytics department by using with large databases of client data to find patterns and predict their involvement with the company. Single-handedly built a pipeline from the group up that ingests client data, cleans and extracts features, compares machine learning models, and returns final predictions.
}
...
\cventry{Aug 2021 -- Jun 2022}{Online Tutor}{Tutor.com}{}{}{Worked with students in science, math, and programming with any problems on an ad-hoc basis. Rated 5 stars by students I've helped.}
...
\section{Other Skills}
    ...
    \cvlistdoubleitem{Bash}         {Mathematica}        
    
    \subsection{Data-Science libraries}
    \cvlistdoubleitem{TensorFlow}       {NumPy}
    \cvlistdoubleitem{pandas}           {scikit-learn}
...
\cvdoublecolumn{
    ...
    \cvreference{David Andexler}
    {Data Operations}
    {Affinaquest}
    {Supervisor}
    {}
    {dandexler@affinaquest.com}
    {}\\[1em]
